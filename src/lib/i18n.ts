...
const en = {
    ...
    taskDueTodayAt: 'Due today, {time}',
    taskDueTomorrow: 'Due tomorrow',
    taskDueTomorrowAt: 'Due tomorrow, {time}',
    taskDueOn: 'Due {date}',
    taskDueOnAt: 'Due {date}, {time}',
    today: 'Today',
    nextSessionAt: '{date}, {time}',
    clientsNextAt: 'Next: {session}',
    clientsProgramCompleted: 'Program completed',
    dismiss: 'Dismiss',
...
const ar: Record<MessageKey, string> = {
    ...
    taskDueTodayAt: 'مستحقة اليوم، {time}',
    taskDueTomorrow: 'مستحقة غدًا',
    taskDueTomorrowAt: 'مستحقة غدًا، {time}',
    taskDueOn: 'مستحقة {date}',
    taskDueOnAt: 'مستحقة {date}، {time}',
    today: 'اليوم',
    nextSessionAt: '{date}، {time}',
    clientsNextAt: 'التالي: {session}',
    clientsProgramCompleted: 'اكتمل البرنامج',
    dismiss: 'تجاهل',
